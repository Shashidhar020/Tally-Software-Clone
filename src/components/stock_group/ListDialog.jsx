...
const ListDialog = ({ title, items, onClose, onSelect, variant}) => {
  ...
  return (
    <div
      style={{
        position:"absolute",
       top: isDropdown ? isListofgroups  ? "5%"  : isUnits  ? "39%"  : isListActions  ? "28%"  : isAction  ? "40%" : isSupply? "57%":  isapplicability?"20%":istaxabilitytype?"45%": "40%" : "32%",
        left: isDropdown? isListofgroups  ? "49%"  : isUnits  ? "5%"  : isListActions  ? "49%"   : isAction  ? "49%"    : isSupply  ? "49%":  isapplicability?"49%":istaxabilitytype?"49%":"40%"  : "16%",
