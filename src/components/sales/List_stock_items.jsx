...
import { useNavigate } from "react-router-dom";
 const List_stock_items=React.memo(({  items, onClose, onSelect }) =>{
    ...
    return (
      ...
      >
        ...
        >
          ...
          <button type="text"  className="ledger-create"  onClick={()=>navigate("/stockItem")}>Create</button>
        </div>
        <div>
...
export default List_stock_items;
