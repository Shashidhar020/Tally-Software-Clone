...
const Country = ({ title, items, onClose, onSelect, variant}) => {
  const isDropdown = variant === "dropdown";
  const isCountry = title ==="List of Country";
  return (
    <div
      style={{
        position:"absolute",
       top: isDropdown ? isCountry?"43%": "40%" : "32%",
        left: isDropdown? isCountry?"65%": "40%"  : "16%",
