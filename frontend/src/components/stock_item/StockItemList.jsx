...
const StockItemList = () => {
  ...
  const filteredLedgers = stockItems ? stockItems.filter(item =>
  ...
  return (
    ...
    <div className="ledger-list-container">
        ...
        <input type="search" placeholder="Search the StockItem " value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} style={{marginLeft:showMenu?"-0px":"100px"}}/>
        <button
