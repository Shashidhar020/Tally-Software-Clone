...
const newItem = {
  ...
  return (
    ...
    >
      ...
      <p  style={{display:"flex", justifyContent:"space-evenly",position:"fixed",top:"93%",border:"2px solid black", width:"100%",backgroundColor:"#212121ff",marginLeft:"-10.5%"}}><span><button
          onClick={save}
          style={{
